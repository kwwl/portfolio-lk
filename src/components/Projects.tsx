...
function Projects() {
  ...
  const projects: Project[] = [
    ...
    {
      id: 4,
      title: "Projets d’Achats Publics",
      description:
        "Analyse et visualisation des projets d’achats publics via des données open‑data (marchés publics, appels d’offres) pour extraire des insights sur les tendances de la commande publique.",
      technologies: ["Python", "Pandas", "Jupyter", "Plotly", "Open Data API"],
      image:
    ...
    },
    {
      ...
      title: "Additif-Model",
      description:
        "Projet de modélisation statistique utilisant un modèle additif (régression linéaire avec features temporelles et indicatrices) pour prédire les ventes de maillots de bain. L’application montre les prédictions sur le jeu d’entraînement et de test, ainsi que les intervalles de confiance à 95 %.",
      technologies: ["Python", "scikit-learn", "Pandas", "NumPy", "Matplotlib", "Feature            Engineering temporel"],
      image:
        "https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg?                        auto=compress&cs=tinysrgb&w=800",
      githubLink: "https://github.com/kwwl/Additif-Model",
      category: "Machine Learning",
    },
    {
      id: 6,
      title: "Credit Risk Prediction – Loan Default AI",
      description:
        "Application interactive qui utilise l’IA pour prédire le risque de défaut d’un prêt tout en montrant de manière transparente le pipeline et les features derrière la décision.",
      technologies: ["Python", "Joblib", "XGBoost", "Scikit-learn", "Pandas / NumPy", "Streamlit"],
      image:
        "https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=800",
      githubLink: "https://github.com/kwwl/credit-risk-prediction",
      category: "Machine Learning",
    },
  ];
